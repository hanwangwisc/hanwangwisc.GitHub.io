...
WTS: $$\forall \epsilon >0, \exists N \in \N, s.t., \forall n\geq N, \forall x\in X, |f_{n}(x)-f(x)|<\epsilon$$.
By pointwise convergence, fix $$x\in X$$, $$\forall \epsilon >0, \exists N_x \in \mathbb{N}, s.t., \forall n\geq N_x, |f_{n}(x)-f(x)|<\epsilon$$.
